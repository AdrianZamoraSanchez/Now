...
class  NowParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProg = 0, RuleExpr = 1, RuleTimeStamp = 2
  };

  explicit NowParser(antlr4::TokenStream *input);

  NowParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
